...
document.addEventListener("DOMContentLoaded", function () {
  ...
  validation
    ...
    .addField('.tel', [{
      ...
      errorMessage: 'Не достаточно символов в строке',
    }]);
...
// Tooltip
Popper.createPopper('.tooltip__txt-1', tooltip, {
  placement: 'top',
});

/*tippy('.tooltip__txt-1', { content: 'Пример современных тенденций - современная методология разработки' });*/
